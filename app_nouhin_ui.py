...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.setMaximumSize(QSize(480, 300))
        font = QFont()
...
"}")
        ...
        self.title_Extraction_conditions = QLabel(self.widget)
        self.title_Extraction_conditions.setObjectName(u"title_Extraction_conditions")
        self.title_Extraction_conditions.setMinimumSize(QSize(101, 21))
        self.title_Extraction_conditions.setMaximumSize(QSize(101, 21))
        font1 = QFont()
        ...
        self.gridLayout.addWidget(self.title_Extraction_conditions, 0, 0, 1, 1)

        self.date_target_year_month = QDateEdit(self.widget)
        self.date_target_year_month.setObjectName(u"date_target_year_month")
        self.date_target_year_month.setMinimumSize(QSize(111, 21))
        self.date_target_year_month.setMaximumSize(QSize(111, 21))
        font2 = QFont()
        ...
        self.frame_btn.setMaximumSize(QSize(440, 51))
