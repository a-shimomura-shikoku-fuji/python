...
"")
        ...
        self.verticalLayout_Sidebar.setContentsMargins(10, 15, 10, 20)
...
"")
        ...
        self.title_common.setMinimumSize(QSize(510, 38))
        self.title_common.setMaximumSize(QSize(510, 38))
        font3 = QFont()
        font3.setFamilies([u"Yu Gothic UI"])
        font3.setPointSize(14)
        font3.setBold(True)
        self.title_common.setFont(font3)
        self.title_common.setStyleSheet(u"color: #1e293b;margin-bottom: 10px;")
        ...
        self.verticalLayout_qa.setContentsMargins(30, 20, 30, 30)
        self.title_qa = QLabel(self.page_qa)
        self.title_qa.setObjectName(u"title_qa")
        self.title_qa.setMinimumSize(QSize(510, 38))
        self.title_qa.setMaximumSize(QSize(510, 38))
        font4 = QFont()
        font4.setFamilies([u"Yu Gothic"])
        font4.setPointSize(14)
        font4.setBold(True)
        self.title_qa.setFont(font4)
        self.title_qa.setStyleSheet(u"color: #1e293b; margin-bottom: 10px;")
        ...
        self.verticalLayout_sales.setContentsMargins(30, 20, 30, 30)
        self.title_sales = QLabel(self.page_sales)
        self.title_sales.setObjectName(u"title_sales")
        self.title_sales.setMinimumSize(QSize(510, 38))
        self.title_sales.setMaximumSize(QSize(510, 38))
        self.title_sales.setFont(font4)
        self.title_sales.setStyleSheet(u"color: #1e293b; margin-bottom: 10px;")
        ...
        self.verticalLayout_admin.setContentsMargins(30, 20, 30, 30)
        self.title_admin = QLabel(self.page_admin)
        self.title_admin.setObjectName(u"title_admin")
        self.title_admin.setMinimumSize(QSize(510, 38))
        self.title_admin.setMaximumSize(QSize(510, 38))
        self.title_admin.setFont(font3)
        self.title_admin.setStyleSheet(u"color: #1e293b; margin-bottom: 10px;")
        ...
        self.verticalLayout_factory.setContentsMargins(30, 20, 30, 30)
        self.title_factory = QLabel(self.page_factory)
        self.title_factory.setObjectName(u"title_factory")
        self.title_factory.setMinimumSize(QSize(510, 38))
        self.title_factory.setMaximumSize(QSize(510, 38))
        self.title_factory.setFont(font3)
        self.title_factory.setStyleSheet(u"color: #1e293b; margin-bottom: 10px;")
    ...
    def retranslateUi(self, MainMenuWindow):
        ...
        self.title_common.setText(QCoreApplication.translate("MainMenuWindow", u"\u5171\u901a\u3000\u696d\u52d9\u652f\u63f4\u30e1\u30cb\u30e5\u30fc", None))
        self.btn_general_search.setText(QCoreApplication.translate("MainMenuWindow", u"\u6c4e\u7528\u691c\u7d22", None))
        self.title_qa.setText(QCoreApplication.translate("MainMenuWindow", u"\u54c1\u8cea\u4fdd\u8a3c\u90e8\u3000\u696d\u52d9\u652f\u63f4\u30e1\u30cb\u30e5\u30fc", None))
        self.title_sales.setText(QCoreApplication.translate("MainMenuWindow", u"\u55b6\u696d\u6280\u8853\u90e8\u3000\u696d\u52d9\u652f\u63f4\u30e1\u30cb\u30e5\u30fc", None))
        self.btn_juchushokai.setText(QCoreApplication.translate("MainMenuWindow", u"\u53d7\u6ce8\u7167\u4f1a", None))
        self.title_admin.setText(QCoreApplication.translate("MainMenuWindow", u"\u7dcf\u52d9\u90e8\u3000\u696d\u52d9\u652f\u63f4\u30e1\u30cb\u30e5\u30fc", None))
        ...
        self.title_factory.setText(QCoreApplication.translate("MainMenuWindow", u"\u88fd\u9020\u90e8\u3000\u696d\u52d9\u652f\u63f4\u30e1\u30cb\u30e5\u30fc", None))
    # retranslateUi
