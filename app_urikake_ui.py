...
"QPushButton:hover { background-color: #cbd5e1; }")
        ...
        self.btn_excel_2 = QPushButton(self.frame)
        self.btn_excel_2.setObjectName(u"btn_excel_2")
        self.btn_excel_2.setGeometry(QRect(250, 10, 51, 31))
        self.btn_excel_2.setFont(font4)
        self.btn_excel_2.setStyleSheet(u"QPushButton { background-color: #1e3a8a; color: #ffffff !important; border: 1px solid #172554; border-radius: 6px; font-weight: bold; }\n"
"QPushButton:hover { background-color: #2563eb; border-color: #60a5fa; }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_excel_2.setText(QCoreApplication.translate("MainWindow", u"\u8a2d\u5b9a", None))
